$(document).ready(function() {	
	...
	$.getData = function(){
		$.ajax({
				...
				url: "ajax1.php", // data is sent to ajax.php
				async   : false,
				data: $( "form" ).serialize()
				})
				.done(function( data ) {
	...
	$( document ).on( "click", "input:a[name=t]", function() {// if the user clicks on gender radio button.
		if($('input:a[href=#t]:checked').val() === "t"){ // if the checked gender is "m"
